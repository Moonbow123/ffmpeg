...
public class FFmpegKit {
    ...
    private final static String TAG = FFmpegKit.class.getSimpleName();
    ...
    public static native int setFontConfigEnvironmentVariable(String variableName, String variableValue);
